...
import fetchEthosUserByTwitter, { fetchUserData } from '../utils/ethosApi';
...
export default function Home() {
  ...
  const handleSearch = async () => {
    ...
    setError(null);
    try {
      const ethosUser = await fetchEthosUserByTwitter(username);
      const profileData = await fetchUserData(username);
      const combinedData = { ethosUser, profileData };
